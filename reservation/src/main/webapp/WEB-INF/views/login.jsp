...
<body class="biz  ko">
	...
	<div class="_view_content" ui-view="content" id="container">
		...
		<div class="booking_login">
			<h1 class="login_header">
				<a href="/reservation/main" class="nbooking_logo spr_bi txt_logo">
				...
				<form name="confirm_form" class="ng-pristine ng-valid" id="form1"
					...
					<div class="login_form">
						<label class="label_form" for="resrv_id"
							...
							class="warning_msg">양식에 어긋난 이메일입니다.</span><span
							class="pass_msg">양식에 맞는 이메일입니다.</span> <input type="text"
	...
	<footer aria-hidden="false">
		...
		<div class="gototop" aria-hidden="false">
			<a href="#" onclick="return false;" class="lnk_top"> <span
		...
		<div id="footer" class="footer">
			<ul class="lst_nav">
				<!---->
				<li class="lnk_item"><a href="#" onclick="return false;"
					class="anchor _logout_link"> <span translate="CM-LOGIN">로그인</span>
				</a></li>
				<!---->
				<!---->
				<li class="lnk_item">
			...
			<dl class="box_vcard">
				<dt class="tit_dt">
					<a href="#" onclick="return false;" class="lnk_naver" title="펼쳐보기">
						<span translate="CM-NAVER_INC">(주)네이버 사업자정보</span> <i
						class="fn fn-down2" aria-hidden="true"></i>
					</a>
				</dt>
				<!---->
			</dl>
			<ul class="lst_link">
				<li class="item"><a class="anchor" ui-sref="policy" href="#"
					onclick="return false;"> <span translate="CM-TERMS">이용약관</span>
				</a></li>
				<li class="item"><a class="anchor" href="#"
					onclick="return false;"> <strong class="policy_em"
						translate="CM-PRIVACY_POLICY">개인정보처리방침</strong>
				</a></li>
				<li class="item"><a href="#" onclick="return false;"
