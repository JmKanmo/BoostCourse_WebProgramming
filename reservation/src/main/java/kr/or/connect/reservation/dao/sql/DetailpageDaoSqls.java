...
public class DetailpageDaoSqls {
	...
	public static final String SELECT_USER_RIVIEW = "SELECT prod.description, RPAD(SUBSTR(ri.reservation_email, 1, 4), 8, '*') AS id, ruc.score, ruc.comment, ruc.modify_date, fi.save_file_name AS fileURL"
