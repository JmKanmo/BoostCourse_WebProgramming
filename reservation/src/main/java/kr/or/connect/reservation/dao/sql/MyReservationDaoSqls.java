...
public class MyReservationDaoSqls {
	public static final String SELECT_BOOKING_HISTORY_BY_EMAIL = "SELECT pv.ticket_price, SUM(rip.count) ticket_count, di.place_name, di.place_lot, di.place_street, prod.id product_id, prod.description, resrv.id reservation_id, resrv.cancel_flag, resrv.reservation_date"
