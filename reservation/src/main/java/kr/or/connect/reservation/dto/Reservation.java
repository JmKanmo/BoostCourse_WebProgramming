...
public class Reservation {
	...
	public String toString() {
		return "Reservation [id=" + id + ", productId=" + productId + ", displayInfoId=" + displayInfoId
				...
				+ ", createDate=" + createDate + ", modifyData=" + modifyDate + "]";
	}

	public List<ReservationPrice> getReservationPrice() {
		return reservationPrice;
	}

	public void setReservationPrice(List<ReservationPrice> reservationPrice) {
