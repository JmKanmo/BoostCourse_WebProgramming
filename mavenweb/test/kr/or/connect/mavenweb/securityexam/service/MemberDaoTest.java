...
public class MemberDaoTest {
	...
	public void getUser() throws Exception {
		System.out.println(memberDao.getMemberByEmail("carami@example.com").getEmail());
		System.out.println(memberRoleDao.getRolesByEmail("carami@example.com").get(0).getRoleName());
	}
}